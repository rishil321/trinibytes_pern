...
import {Category} from "../entities/CaribbeanJobsPost.js";
import dbConnectionObj from "../configs/typeOrmDbObj.js";
...
export async function getCaribbeanJobsPostings() {
    try {
        ...
        createConnection(dbConnectionObj).then(async connection => {
